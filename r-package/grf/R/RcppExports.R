...
regression_train <- function(input_data, sparse_input_data, outcome_index, weight_index, mtry, num_trees, num_threads, min_node_size, sample_fraction, seed, honesty, ci_group_size, alpha, imbalance_penalty, clusters, samples_per_cluster) {
    .Call('_grf_regression_train', PACKAGE = 'grf', input_data, sparse_input_data, outcome_index, weight_index, mtry, num_trees, num_threads, min_node_size, sample_fraction, seed, honesty, ci_group_size, alpha, imbalance_penalty, clusters, samples_per_cluster)
}
